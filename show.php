...
echo "<table id=\"demoB\"> <style> tr:nth-child(odd) { background: #00FFFF; } td {
                border: 1px solid white; 
            } #demoB th { position: sticky;
top: 0px;
z-index:2;
} table {color: white; background-color: black; display:block; overflow-x: scroll; max-width: 300px; white-space: nowrap;}</style>";
echo "<thead> <tr><th>Name</th><th>EMail</th><th>Phone</th><th>City</th><th>Language</th><th>Checkboxes</th><th>Date</th><th>Time</th></tr></thead>";            
echo "<tbody>";         
